...
export default function ExercisesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Modal de ejercicio */}
      {selectedExercise && (
        <Dialog open={!!selectedExercise} onOpenChange={(open) => !open && handleCloseExerciseModal()}>
            ...
            <div className="space-y-6 py-4">
              {showVideo ? (
                ...
                <div className="text-center">
                  <img 
                    ...
                    alt={selectedExercise.imageDescription} 
                    className="w-full max-w-md mx-auto rounded-lg shadow-md object-cover h-64"
                  />
                  <Button 
                    onClick={() => handleWatchVideo(selectedExercise)} 
                    className="mt-4"
                    variant="outline"
                  >
                    <Play className="w-4 h-4 mr-2" />
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="font-semibold">{selectedExercise.duration}</div>
                  <div className="text-sm text-gray-600">Duración</div>
                </div>
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <Star className="w-6 h-6 text-yellow-500 mx-auto mb-2" />
                  <div className="font-semibold">{selectedExercise.difficulty}</div>
                ...
                <div className="text-center p-4 bg-gray-50 rounded-lg col-span-2 md:col-span-1">
                  ...
                  <div className="font-semibold">{selectedExercise.category}</div>
              ...
              <div className="text-center pt-4 flex gap-4 justify-center">
                <Button onClick={() => handleStartExercise(selectedExercise)} size="lg">
                  <Play className="w-5 h-5 mr-2" />
                  Comenzar Ejercicio
                </Button>
                {!showVideo && (
                  <Button onClick={() => handleWatchVideo(selectedExercise)} variant="outline" size="lg">
                    <Play className="w-5 h-5 mr-2" />
                    Ver Video
                  </Button>
                )}
                {showCreateRoutine && (
                  <Button onClick={() => handleAddToRoutine(selectedExercise)} variant="outline" size="lg">
