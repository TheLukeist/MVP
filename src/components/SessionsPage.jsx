          ...
          <motion.div key={session.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }}>
            <Card className="h-full flex flex-col hover:shadow-lg transition-shadow">
              ...
              <CardContent className="flex-grow flex flex-col">
                <div className="mb-4">
                  <img  alt={`Imagen de la sesión ${session.title}`} className="w-full h-48 object-cover rounded-lg" src="https://images.pexels.com/photos/3768916/pexels-photo-3768916.jpeg" />
                </div>
